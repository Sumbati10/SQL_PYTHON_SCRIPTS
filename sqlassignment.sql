...
-- a query to find the total number of students and display it as TotalStudents.
...
-- a query to count the number of students in each program and display the results in descending order of count. Name the count column as Numberof Students
